...
export default function DatePick() {
  ...
  const renderCalendar = () => {
    ...
    for (let i = 1; i <= daysInMonth; i++) {
      ...
      dayDiv.className =
        "flex h-[38px] w-[38px] items-center justify-center rounded-[7px] border-[.5px] border-transparent text-black hover:border-stroke hover:bg-gray-2 sm:h-[46px] sm:w-[47px] mb-2";
          ...
          {isCalendarOpen && (
            ...
            >
              ...
              <div className="flex items-center space-x-3 pt-4 sm:space-x-5">
                <button
                  id="cancelBtn"
                  className="flex h-[50px] w-full items-center bg-black justify-center rounded-md bg-dark text-base font-medium text-white hover:bg-opacity-90"
                ...
                <button
                  id="cancelBtn"
                  className="flex h-[50px] w-full items-center justify-center bg-sky-800 rounded-md bg-primary text-base font-medium text-white hover:bg-blue-dark"
                  onClick={handleApply}
                >
                  Done
                </button>
