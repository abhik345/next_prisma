                  ...
                  <ul className="block lg:flex">
                    <li className="relative">
                      <button
                        ...
                        className="flex w-full items-center justify-between gap-2 py-2 text-base font-medium text-body-color hover:text-dark lg:ml-12 lg:inline-flex lg:w-auto lg:justify-center text-white hover:text-gray-200"
                      >
                        Resources
                        <span
                          className={`${
                      ...
                      >
                        <div className="rounded-t-xl bg-white p-2 lg:p-8 ">
                          <div className="mb-8">
                            <h4 className="mb-1 text-base font-medium text-dark text-black">
                              Resources
                            </h4>
                          ...
                          <div className="grid gap-y-2 lg:grid-cols-2 lg:gap-x-5">
                            ...
                            >
                              ...
                              <div>
                                <h3 className="mb-1 text-base font-semibold text-dark duration-200 group-hover:text-primary text-black group-hover:text-primary">
                                  About Company
                                </h3>
                                <p className="text-sm text-body-color dark:text-dark-6">
                    ...
                    <li>
                      <a
                        href="#"
                        className="flex py-2 text-base font-medium text-body-color hover:text-dark lg:ml-12 lg:inline-flex text-white hover:text-gray-200"
                      >
                        Home
                      </a>
                    </li>
